...
namespace CommonLibrary
{
    ...
    /// 不允许实例化，在应用时直接调用即可
    /// </summary>
    public abstract class SqlCoreHelper
    {
        //加载appsetting.json
     ...
     .AddJsonFile("appsettings.json").Build();
        ...
        {
            return ExecuteScalar(SqlCoreHelper.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlCoreHelper.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlCoreHelper.connectionString, CommandType.Text, cmdText, commandParameters);
        }
